...
#define AP_MOTORS_HELI_SINGLE_SWASH_H1                         0
#define AP_MOTORS_HELI_SINGLE_SWASH_H3                         1
...
protected:
    ...
    AP_Int16        _aileron_comp;              // Mixes collective with aileron input to tune out interaction
    AP_Int16        _elevator_comp;             // Mixes collective with elevator input to tune out interaction
